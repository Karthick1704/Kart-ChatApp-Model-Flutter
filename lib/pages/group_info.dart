...
class GroupInfo extends StatefulWidget {
  ...
  const GroupInfo({Key? key, required this.groupId,
    required this.groupName, required this.adminName}) : super(key: key);
...
class _GroupInfoState extends State<GroupInfo> {
  ...
  getMembers() async{
    ...
    getMembers(widget.groupId).then((val){
      setState(() {
        members = val;
      });
    });
                        ...
                        actions: [
                          ...
                          IconButton(
                              onPressed: () async{
                                ...
                                currentUser!.uid).toggleGroupJoin(widget.groupId,
              ...
              child: Row(
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [Text("Group : ${widget.groupName}",
